      ...
      <main>
        ...
        <header className="header">
          {settings?.logo_url ? (
            <a href="#" style={{ display: 'flex', alignItems: 'center' }}>
              <img src={settings.logo_url} alt="Phan Gia" style={{ height: '44px', display: 'block' }} />
            </a>
          ) : (
            <div className="logo">PHAN GIA</div>
          )}

          <nav>
            {menuItems && menuItems.length > 0
              ? menuItems.map((m) => (
                  <a key={m.id} href={m.duong_dan}>
                    {m.nhan}
                  </a>
                ))
              : (
          ...
          <a className="header-button" href="#lien-he">
            NHẬN BÁO GIÁ
          </a>
        </header>
        ...
        <footer>
          <div className="footer-brand">
            <div className="footer-logo">PHAN GIA</div>

            <p>
              Giải pháp quảng cáo chuyên nghiệp
              <br />
          ...
          <p className="footer-copy">
            © 2026 Phan Gia. All rights reserved.
          </p>
        </footer>
      </main>
